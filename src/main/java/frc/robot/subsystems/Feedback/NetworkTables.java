...
public class NetworkTables {
    ...
    public void printData() {
        double rawFrontLeftEncoder = mainTable.getEntry("Module[frontleft] Raw Absolute Encoder").getDouble(0);
        System.out.println(rawFrontLeftEncoder);
    }

    public double[] returnEncoderData() {
        absoluteFrontLeftEncoder = mainTable.getEntry("Module[frontleft] Raw Absolute Encoder").getDouble(0);
        absoluteFrontRightEncoder = mainTable.getEntry("Module[frontright] Raw Absolute Encoder").getDouble(0);
        absoluteBackLeftEncoder = mainTable.getEntry("Module[backleft] Raw Absolute Encoder").getDouble(0);
        absoluteBackRightEncoder = mainTable.getEntry("Module[backright] Raw Absolute Encoder").getDouble(0);
    ...
    public double[] returnDriveData() {
        ...
        driveFrontRightEncoder = mainTable.getEntry("Module[frontright] Raw Drive Encoder").getDouble(0);
