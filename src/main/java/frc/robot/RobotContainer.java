...
public class RobotContainer {
    ...
    private static ShuffleboardSubsystem shuffle = ShuffleboardSubsystem.getInstance(); // Getting instance of
    // Shooter
    // Subsystem

    public BooleanSupplier isRedAliance = () -> DriverStation.getAlliance().isPresent()
    ...
    boolean speakerShot = true; // Whether the robot is ready for a Speaker Shot or not. Initialized to true
    // because our
    ...
    public RobotContainer() {
        ...
        // 2 in Amp");
        // autos.addOption("(SOURCE) 3 in Speaker + 2 in Amp", "(SOURCE) 3 in Speaker +
        // 2 in Amp");
        // autos.addOption("(AMP) Left Side 2 in Speaker + 2 in Amp", "(AMP) Left Side 2
        // in Speaker + 2
        // in Amp");
     ...
     * joysticks}.
     */
    public final IntSupplier shooterRPM = () -> speakerShot ? Shooter.speakerShootRPM : Shooter.ampShootRPM;

    public final IntSupplier shooterWaitTime = () -> speakerShot ? Shooter.speakerWaitTime : Shooter.ampWaitTime;
    ...
    public BooleanSupplier isLimelightButtonPressed = () -> CoPilotController
            .getRawButton(copilotController.limelightButton);
    ...
    public void printSquareify() {
        double[] squareifedInputs = drivebase.squareifyInput(driverXbox.getLeftX(), driverXbox.getLeftY());
        shuffle.setTab("Debugging");
